...
@section('content')
    @if(isset($dish) && isset($ingredientIds) && isset($image))
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-7" style="background-color: navajowhite; padding: 50px; border-radius: 40px;">
                    <img height="500px" width="500px"  src="{{url($image->path)}}" alt="" style="border-radius: 10px">
                    <div style="margin-top: 30px"><h2>{{ $dish->name }}</h2></div>
